...
public class TicTacToe
{
	...
	{
		String prompt = "Welcome to Tic-Tac-Toe. We will use a-b-c for the rows and 1-2-3 for the columns. \nPlease enter your first move: ";
		String UserMove = "";
		String computerMove = "";
		...
		// Each time through the loop, both the user and the computer play.
		...
		for (int i = 1; i <=9; i++)
		{
			...
			if (i < 9)
			{
				...
				System.out.println("Computer chose to play " + computerMove);
